...
#               hannschuach. Die Messung laeuft ueber hole() selbst und
...
FELDER = {
    ...
    # Seal U Design vom 14.09.2026 aufgeloest worden (Issue #1, hannschuach).
    ...
    # dessen App bar anzeigt (hannschuach, 14.09.2026) - EIN Fahrzeug,
...
ABGELEITET = {
    ...
    #
    # Die Bedeutung ist BELEGT, nicht geraten: hannschuach hat den Wert in
...
def einmischen(ziel: dict, quelle: dict) -> None:
    ...
    Design (Issue #1, hannschuach): der Echtzeit-Abschnitt fuehrt
